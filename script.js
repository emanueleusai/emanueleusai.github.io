...
let scene, camera, renderer, detector, background, uniforms, model;
...
const layers = [
'models/Tracks_V3.glb',
'models/EBRecHits_V2.glb',
'models/EcalBarrel3D_V1.glb',
'models/EERecHits_V2.glb',
'models/Event_V2.glb',
'models/GsfElectrons_V2.glb',
'models/HBRecHits_V2.glb'
  ];

const loader = new GLTFLoader();
layers.forEach(layer => {

loader.load(layer, (gltf) => {
    model = gltf.scene;
  ...
  // const loader = new GLTFLoader();
  // loader.load('models/Tracks_V3.glb', (gltf) => {
  //   model = gltf.scene;
  //   model.scale.set(1, 1, 1);
  //   group.add(model);
  // });
  // loader.load('models/EERecHits_V2.glb', (gltf) => {
  //   model = gltf.scene;
  //   model.scale.set(1, 1, 1);
  //   group.add(model);
  // });
